            ...
            if (op == 1) {
                ...
                while (p1.getHealth() > 0 && p2.getHealth() > 0) {
                    ...
                    if (currentAttacker == p1) {
                        ...
                        action = random.nextInt(4) + 1;
                        System.out.println("Máquina escolheu ação: " + action);
                    }
                    ...
                    switch (action) {
                        ...
                        case 3:
                            if (currentAttacker == p1) {
                                ...
                                int healChoice = random.nextInt(2) + 1;
                                if (healChoice == 1) {
                                    maxHeal.heal(currentAttacker);
                                    System.out.println("Máquina usou MaxHeal!");
                                } else {
                                    minHeal.heal(currentAttacker);
                                    System.out.println("Máquina usou MinHeal!");
                                }
                            }
                            break;
                        ...
                        case 4:
                            if (currentAttacker == p1) {
                                ...
                                int armyAction = random.nextInt(2) + 1;
                                if (armyAction == 1) {
                                    System.out.println(currentAttacker.getArmy().WarCry());
                                } else {
                                    currentAttacker.getArmy().atacar(currentDefender);
                                    System.out.println("Máquina usou o exército para atacar!");
                                    System.out.println("A vida de " + currentDefender.getName() + " caiu para: " + currentDefender.getHealth());
                                }
                            }
                            break;
